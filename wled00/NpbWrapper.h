...
//PIN CONFIGURATION
#ifndef LEDPIN
#define LEDPIN 17  //strip pin. Any for ESP32, gpio2 or 3 is recommended for ESP8266 (gpio2/3 are labeled D4/RX on NodeMCU and Wemos)
#endif
...
// What pins to use:
#define STRIP1_PIN 17 // manually specify all pins here.  2  is default LEDPIN for esp32dev boards.
...
#define STRIP1_LEDCOUNT 150
#define STRIP2_LEDCOUNT 150
#define STRIP3_LEDCOUNT 0
#define STRIP4_LEDCOUNT 0
